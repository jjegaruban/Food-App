    ...
    <div>
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[600px] ">
        ...
        <div className="flex flex-col justify-center gap-8 text-center md:text-left pt-24 md:p-0 pb-10">
          ...
          <p className="">
          Indulge in a world of flavors with our mouth-watering dishes, crafted with fresh ingredients and a passion for taste. From sizzling appetizers to rich, savory main courses, every bite is a delight. Treat yourself to the ultimate dining experience!
          </p>
